...
def singola_bestemmia():
    bestemmia = [
        ...
        "Dio, Madonna e tutti gli angeli in colonna ",
        "Gesù scalzo in una valle di chiodi ",
        "Gesù cieco in una valle di spigoli ",
        "Porco Dio e Padre Pio ",
        "Bastardo il clero ",
        "Madonna cagna ",
        "Dio cantante, Madonna musicante, Giuseppe batterista e Cristo in autopista ",
        "Maria putrefatta ",
        "Dio bastardo ",
        "Madonna inculata da cristo, quel bastardo",
    ]
